...
def enviar_correo_credenciales(correo_destino: str, nombre_completo: str, cuenta: str, contrasena: str, rol: str):
    if rol.lower() == "alumno":
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333;">
            <p>Hola <b>{nombre_completo}</b>,</p>
            <p>Tu cuenta ha sido creada exitosamente en el sistema institucional, puedes acceder sin ningun problema con tus credenciales.</p>
...
def enviar_correo_rechazo_guardia(correo_destino: str, nombre_completo: str, motivo: str):
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333;">
        ...
        <p>Te recordamos que acumular 3 reportes resultará en el bloqueo automático de tu permiso y se te negara el acceso a el portal de alumno con tu cuenta institucional.</p>
        <p><b>Atentamente<br>Administración CUUT</b></p>
    </body>
    </html>
    """
...
def enviar_correo_vencimiento_agrupado(correo_destino: str, nombre_completo: str, tiene_locker: bool, tiene_estacionamiento: bool):
    if tiene_locker and tiene_estacionamiento:
        ...
        accion_texto = "acceder a las instalaciones o ocupar algun locker"
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333;">
        ...
        <p>Por lo tanto, tu documento oficial ha <b>VENCIDO</b> y ya no es válido para {accion_texto} en la institucion.</p>
